...
export default function ChangeVehicleModal({
  isOpen,
  onClose,
  onConfirm,
  ...
  return createPortal(
    ...
    >
      ...
      {/* Modal */}
      <div
        className="bg-[#f4f4f5] relative rounded-[12px] w-auto flex flex-col gap-[24px] items-start p-[24px] z-10"
        data-name="Modal / Change Vehicle"
      >
        <div
          aria-hidden="true"
        ...
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
          <div className="content-stretch flex items-center relative shrink-0 w-full">
            <p className="flex-[1_0_0] font-normal leading-[1.5] min-h-px min-w-px not-italic overflow-hidden relative text-[#71717a] text-[14px]">Alterar o veículo irá remover todos os serviços e itens já adicionados.</p>
          </div>
          <div className="content-stretch flex items-center relative shrink-0 w-full">
            <p className="flex-[1_0_0] font-normal leading-[1.5] min-h-px min-w-px not-italic overflow-hidden relative text-[#71717a] text-[14px]">Esta ação não pode ser revertida.</p>
          </div>
        </div>
