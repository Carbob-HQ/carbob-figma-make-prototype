              ...
              >
                <Check
                  className={`size-4 shrink-0 transition-opacity duration-200 ease-out ${
                    value === v.name ? "opacity-100 text-[#27272a]" : "opacity-0"
                  }`}
                />
                <div className="flex flex-col items-start gap-[2px]">
                  <span className="text-[14px] text-[#27272a] leading-[1.5]">{v.name}</span>
                  <span className="text-[12px] text-[#71717a] leading-[1.5]">{formatYearRange(v)}</span>
                </div>
              </button>
            ))}
          </div>
