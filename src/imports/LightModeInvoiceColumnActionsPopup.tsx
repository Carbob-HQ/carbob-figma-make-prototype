import svgPaths from "./svg-ca11n9opp9";
    ...
    <div className="bg-[#27272a] min-w-[192px] relative rounded-[8px] shrink-0 w-full" data-name="Submenu 1">
      ...
      <div className="flex flex-col justify-center min-w-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center min-w-[inherit] p-[4px] relative w-full">
          ...
          <div className="relative shrink-0 w-full" data-name="New OR Button">
            <div className="flex flex-col items-center justify-center size-full">
              <div className="content-stretch flex flex-col items-center justify-center px-[8px] relative w-full">
                <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Dark Mode / Button">
                  <div className="flex flex-row items-center max-h-[inherit] min-h-[inherit] size-full">
          ...
          <div className="relative shrink-0 w-full" data-name="New Client Button">
            <div className="flex flex-col items-center justify-center size-full">
              <div className="content-stretch flex flex-col items-center justify-center px-[8px] relative w-full">
                <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Dark Mode / Button">
                  <div className="flex flex-row items-center max-h-[inherit] min-h-[inherit] size-full">
          ...
          <div className="relative shrink-0 w-full" data-name="New Vehicle Button">
            <div className="flex flex-col items-center justify-center size-full">
              <div className="content-stretch flex flex-col items-center justify-center px-[8px] relative w-full">
                <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Dark Mode / Button">
                  <div className="flex flex-row items-center max-h-[inherit] min-h-[inherit] size-full">
...
export default function LightModeInvoiceColumnActionsPopup() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Light Mode / Invoice Column Actions Popup">
      <Submenu />
    </div>
  );
}