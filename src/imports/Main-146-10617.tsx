import svgPaths from "./svg-piuh2r9ja5";
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-[360px] overflow-x-clip overflow-y-auto pb-[40px] relative" data-name="Content">
      <div className="content-stretch flex flex-col gap-[12px] items-start mb-[-40px] relative shrink-0 w-full" data-name="Light Mode / Input">
        <Input />
      </div>
