import svgPaths from "./svg-l83c9o2lhj";
...
function Services() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px overflow-x-clip overflow-y-auto relative w-full" data-name="Services">
      <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Service Frame">
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-full items-start min-h-px min-w-[360px] overflow-clip relative" data-name="Content">
