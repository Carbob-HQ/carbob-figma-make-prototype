import svgPaths from "./svg-q6boidsovw";
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px overflow-x-clip overflow-y-auto relative w-full" data-name="Main">
      <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Light Mode / Button">
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[16px] relative w-full">
            <p className="flex-[1_0_0] font-medium leading-[1.5] min-h-px min-w-px not-italic relative text-[#27272a] text-[14px] whitespace-pre-wrap">Gerais</p>
      ...
      <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Light Mode / Button">
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[16px] relative w-full">
            <p className="flex-[1_0_0] font-medium leading-[1.5] min-h-px min-w-px not-italic relative text-[#27272a] text-[14px] whitespace-pre-wrap">Mudança de óleo</p>
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Right Icon">
              <div className="absolute inset-[20.83%_33.33%]" data-name="Vector (Stroke)">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.33323 9.33313">
                  <path d={svgPaths.p2063d280} fill="var(--fill-0, #A1A1AA)" id="Vector (Stroke)" />
      ...
      <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Light Mode / Button">
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[16px] relative w-full">
            <p className="flex-[1_0_0] font-medium leading-[1.5] min-h-px min-w-px not-italic relative text-[#27272a] text-[14px] whitespace-pre-wrap">Ar condicionado</p>
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Right Icon">
              <div className="absolute inset-[20.83%_33.33%]" data-name="Vector (Stroke)">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.33323 9.33313">
                  <path d={svgPaths.p2063d280} fill="var(--fill-0, #A1A1AA)" id="Vector (Stroke)" />
      ...
      <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Light Mode / Button">
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[16px] relative w-full">
            <p className="flex-[1_0_0] font-medium leading-[1.5] min-h-px min-w-px not-italic relative text-[#27272a] text-[14px] whitespace-pre-wrap">Pastilhas e discos</p>
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Right Icon">
              <div className="absolute inset-[20.83%_33.33%]" data-name="Vector (Stroke)">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.33323 9.33313">
                  <path d={svgPaths.p2063d280} fill="var(--fill-0, #A1A1AA)" id="Vector (Stroke)" />
      ...
      <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Light Mode / Button">
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[16px] relative w-full">
            <p className="flex-[1_0_0] font-medium leading-[1.5] min-h-px min-w-px not-italic relative text-[#27272a] text-[14px] whitespace-pre-wrap">Amortecedores</p>
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Right Icon">
              <div className="absolute inset-[20.83%_33.33%]" data-name="Vector (Stroke)">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.33323 9.33313">
                  <path d={svgPaths.p2063d280} fill="var(--fill-0, #A1A1AA)" id="Vector (Stroke)" />
      ...
      <div className="max-h-[40px] min-h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Light Mode / Button">
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[16px] relative w-full">
            <p className="flex-[1_0_0] font-medium leading-[1.5] min-h-px min-w-px not-italic relative text-[#27272a] text-[14px] whitespace-pre-wrap">Correia de distribuição</p>
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Right Icon">
              <div className="absolute inset-[20.83%_33.33%]" data-name="Vector (Stroke)">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.33323 9.33313">
                  <path d={svgPaths.p2063d280} fill="var(--fill-0, #A1A1AA)" id="Vector (Stroke)" />
...
function Main() {
  return (
    <div className="bg-[rgba(39,39,42,0.05)] flex-[1_0_0] min-h-px min-w-px relative rounded-[16px] w-full" data-name="Main">
...
function LeftFrame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-full items-start min-h-px min-w-px relative" data-name="Left Frame">
      <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Light Mode / Tab Groups">
        ...
        <div className="content-stretch flex gap-[8px] items-center justify-center px-[8px] py-[12px] relative shrink-0" data-name="Tab 1">
          ...
          <p className="font-medium leading-[1.5] not-italic relative shrink-0 text-[#27272a] text-[14px] text-center">Serviços da oficina</p>
        </div>
        <div className="content-stretch flex gap-[8px] items-center justify-center px-[8px] py-[12px] relative shrink-0" data-name="Tab 2">
          <p className="font-medium leading-[1.5] not-italic relative shrink-0 text-[#71717a] text-[14px] text-center">Serviços diferidos</p>
        </div>
        <div className="content-stretch flex gap-[8px] items-center justify-center px-[8px] py-[12px] relative shrink-0" data-name="Tab 3">
          <p className="font-medium leading-[1.5] not-italic relative shrink-0 text-[#71717a] text-[14px] text-center">Manutenção programada</p>
        </div>
        <div className="content-stretch flex gap-[8px] items-center justify-center px-[8px] py-[12px] relative shrink-0" data-name="Tab 4">
          <p className="font-medium leading-[1.5] not-italic relative shrink-0 text-[#71717a] text-[14px] text-center">Pesquisa de serviços</p>
        </div>
        <div className="content-stretch flex gap-[8px] items-center justify-center px-[8px] py-[12px] relative shrink-0" data-name="Tab 5">
          <p className="font-medium leading-[1.5] not-italic relative shrink-0 text-[#71717a] text-[14px] text-center">Pesquisa gráfica</p>
        </div>
      </div>
      <Main />
    </div>
...
function TopFrame1() {
  return (
    <div className="content-stretch flex flex-col h-[40px] items-start pt-[10px] relative shrink-0 w-full" data-name="Top Frame">
      <div className="content-stretch flex h-[24px] items-center relative shrink-0 w-[320px]" data-name="Light Mode / Heading">
        <p className="flex-[1_0_0] font-medium leading-[1.25] min-h-px min-w-px not-italic relative text-[#27272a] text-[16px] whitespace-pre-wrap">Serviços selecionados</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Services">
      <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Light Mode / Text">
        <p className="flex-[1_0_0] font-normal leading-[1.5] min-h-px min-w-px not-italic overflow-hidden relative text-[#71717a] text-[14px] text-ellipsis whitespace-pre-wrap">Lista de serviços vazia.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Text Frame">
      <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Light Mode / Heading">
        <p className="flex-[1_0_0] font-medium leading-[1.25] min-h-px min-w-px not-italic relative text-[#27272a] text-[16px] whitespace-pre-wrap">Total c/ IVA</p>
      </div>
      <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Total">
        <p className="font-medium leading-[1.25] not-italic relative shrink-0 text-[#27272a] text-[16px]">0,00€</p>
      </div>
    </div>
  );
}
...
function SummaryFrame() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[320px]" data-name="Summary Frame">
      <TextFrame />
      <div className="bg-[#27272a] max-h-[40px] min-h-[40px] opacity-30 relative rounded-[8px] shrink-0 w-full" data-name="Light Mode / Button">
        <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[8px]" />
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[16px] relative w-full">
            <p className="font-medium leading-[1.5] not-italic relative shrink-0 text-[14px] text-white">Adicionar serviços</p>
          </div>
        </div>
...
function RightFrame() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-full items-start relative shrink-0 w-[320px]" data-name="Right Frame">
...
function ContentFrame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-start min-h-px min-w-px relative w-full" data-name="Content Frame">
      <LeftFrame />
      <RightFrame />
    </div>
  );
...
export default function ModalAddServices() {
  return (
    <div className="bg-[#f4f4f5] content-stretch flex flex-col gap-[24px] items-start p-[24px] relative rounded-[12px] size-full" data-name="Modal / Add Services">
      ...
      <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="Light Mode / Card Items / Header Block">
        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-center justify-center min-h-px min-w-px relative" data-name="Light Mode / Card Items / Header">
          <p className="font-medium leading-[1.25] not-italic relative shrink-0 text-[#27272a] text-[16px] w-full whitespace-pre-wrap">Guia de serviços - Renault Clio IV 1.5 dCi 75cv</p>
        </div>
