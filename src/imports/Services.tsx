import svgPaths from "./svg-g6gesquaqq";

function Frame() {
  return (
    <div className="bg-[#60a5fa] content-stretch flex items-center justify-center relative shrink-0" data-name="Frame">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#3f3f46] text-[16px] text-left">Novo serviço</p>
    </div>
  );
}
...
function HeaderFrame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-[32px] min-w-px relative" data-name="Header Frame">
      ...
      <button className="content-stretch cursor-pointer flex flex-[1_0_0] gap-[8px] items-center min-h-px min-w-px relative" data-name="Service Frame / Title">
        <LightModeInput />
      </button>
    </div>
  );
...
export default function Services() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Services">
      <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Manual Service Frame">
