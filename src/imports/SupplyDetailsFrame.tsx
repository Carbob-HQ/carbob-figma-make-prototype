import svgPaths from "./svg-emfk564wtf";
...
export default function SupplyDetailsFrame() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative size-full" data-name="Supply Details Frame">
