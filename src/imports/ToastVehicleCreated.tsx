import svgPaths from "./svg-zf1revg58u";
...
export default function ToastVehicleCreated() {
  return (
    <div className="content-stretch flex flex-col items-start p-[24px] relative size-full" data-name="Toast / Vehicle Created">
      <Input />
    </div>
  );
}