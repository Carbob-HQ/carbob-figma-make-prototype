import svgPaths from "./svg-l567e6nsxp";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="font-['Inter:Medium',sans-serif] font-medium h-[20px] leading-[1.5] not-italic relative shrink-0 text-[14px] text-white w-full whitespace-pre-wrap">Veículo associado com sucesso</p>
    </div>
  );
}
